        ...
        <div className='flex gap-4 w-max'>
          ...
          <div className='service-card bg-white shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden flex-shrink-0 w-72' style={{borderTopLeftRadius: '16px', borderTopRightRadius: '16px'}}>
            ...
            <div className='p-4'>
              ...
              <p className='text-xs text-gray-600 leading-relaxed mb-3'>
                Expert A/C repair services to keep your home cool and comfortable year-round. We service all brands with fast response times and competitive pricing.
              </p>
      ...
      <div className='hidden sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6'>
        ...
        <div className='service-card bg-white shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden' style={{borderTopLeftRadius: '40px', borderTopRightRadius: '40px'}}>
          ...
          <div className='p-4'>
            ...
            <p className='text-xs text-gray-600 leading-relaxed mb-3'>
              Expert A/C repair services to keep your home cool and comfortable year-round. We service all brands and models, providing maintenance, repairs, and emergency services with fast response times and competitive pricing.
            </p>
            <p className='text-xs text-gray-500 mb-2'>by Robert Chen</p>
            <div className='flex items-center justify-between mb-3'>
              <div className='flex items-center'>
        ...
        <div className='service-card bg-white shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden' style={{borderTopLeftRadius: '40px', borderTopRightRadius: '40px'}}>
          ...
          <div className='p-4'>
            ...
            <p className='text-xs text-gray-600 leading-relaxed mb-3'>
              Expert hair styling services to give you the perfect look for any occasion. From cuts and colors to special event styling, our professional stylists use premium products and latest techniques to achieve stunning results.
            </p>
            <p className='text-xs text-gray-500 mb-2'>by Emma Wilson</p>
            <div className='flex items-center justify-between mb-3'>
              <div className='flex items-center'>
